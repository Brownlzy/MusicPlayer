...
//获取配置
export const getInfo = (params) => request.get(`info`);
//获取所有歌单
export const getallSongList = (params) => request.get(`allsonglist`);
//获取歌单
export const getsongList = (params) => request.get(`songlist?name=${params.name}`);
//获取歌曲信息
